RailsAdmin::Engine.routes.draw do
  controller "main" do
    ...
    scope ":model_name" do
      ...
      scope ":id" do
        RailsAdmin::Config::Actions.all(:member).each { |action| match "/#{action.route_fragment}", :to => action.action_name, :as => action.action_name, :via => action.http_methods, :constraints => {:id => /.*/ } }
      end
    end
  end
end
